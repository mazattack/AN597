...
Tar<-c("Tarsiidae")
Tar
Anth<-list(list("Platyrrhini", Plat), list("Catarrhini", Cat))
Anth
Hap<-list(list("Anthropoidea", Anth), list("Tarsioidea", Tar))
Hap
Strep<-list(list("Lorisoidea", c("Lorisidae", "Galagidae")), list("Lemuroidea", c("Cheirogaleidae", "Lepilemuridae", "Indriidae", "Lemuridae", "Daubentoniidae")))
Strep
Tax<- list("Primates", list(list("Haplorhini", Hap), list("Strepsirhini", Strep)))
Tax          
```

This is way too complicated to know if I got the heirarchy right. There has to be an easier way
